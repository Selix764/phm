...
import { Play, RefreshCw, ExternalLink, Calendar, Eye, X } from "lucide-react"
...
interface EducationInspirationSectionProps {
  maxVideos?: number
  channelId?: string
}

export function EducationInspirationSection({
  maxVideos = 3,
  channelId = "UCVcQFFnRV6gaOyM8l7YmjMw",
}: EducationInspirationSectionProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {limitedVideos.map((video) => (
            <div key={video.id} className="bg-[#111111] rounded-lg overflow-hidden group">
              <div className="cursor-pointer" onClick={() => setActiveVideo(video.youtubeId)}>
